<template>
    <div class="c-updateAvailable">
        ...
        <div class="c-logo" transition="project">
            <svg width="330" height="330" viewBox="0 0 330 330" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <g fill="none" fill-rule="evenodd">
                    ...
                    <g stroke-width="5">
                        <path d="M102.013 105.372l49.846 103.795H52.167l49.846-103.795zM87.06 209.167h29.908v10.38H87.059v-10.38zM215.235 209.167h29.908v10.38h-29.908v-10.38zm14.954-103.795l49.846 103.795h-99.692l49.846-103.795z" stroke="#F1F1F1" />
        ...
        <h1 class="o-headline-2">Haul {{ version }}</h1>

        <p class="o-paragraph u-marginTopSmall">There is a new version available.</p>
        <p class="o-paragraph u-marginTopSmall">We're working on the auto update but for now you have to get the new version at the
            <button class="o-linkBtn" type="button" v-open-external="'https://github.com/andreasvirkus/haul/releases'">releases page</button> yourself. :)</p>

        <button class="o-primaryBtn u-marginTop" type="button" v-open-external="'https://github.com/andreasvirkus/haul/releases'">Download</button>
    </div>
</template>
